...
## 2021-04-28 - Day 7: Component review

- Task summary: This was the middle stretch where the project started feeling real. I kept going and tried to interpret what the main components are capturing in plain language, then cleaned up whatever looked confusing or weak from the earlier days. Once the base made some sense, I could finally move a bit faster and stop second guessing every tiny decision. A lot of this also meant checking if the numbers were making sense and not just trusting the frist result that showed up.
- Deliverable: Ended the day with component notes in hand, plus a few side notes on what still needed fixing later. It was not super polished, just stable enough that I felt okay moving forward.
## 2021-04-29 - Day 8: Visualization
...
## 2021-05-03 - Day 10: Notebook cleanup check
...
- Deliverable: Ended the day with readable notebook in hand, plus a few side notes on what still needed fixing later. It was not super polished, just stable enough that I felt okay moving forward.
## 2021-05-04 - Day 11: README wrap

- Task summary: Used the last day on Iris PCA Analysis to slow down and finish the loose ends. I mainly had to write a simple README that covers dataset, method, and findings and make sure the project told a clean story from start to finish. Most of the heavy lifting was already done, so this part was more about making the rough edges less obvious. I kept bouncing between the notebook, small observations, and quick plots until the direction felt usable.
- Deliverable: Finished with project README looking decent enough to call this version done, even if I could still nitpick a few things. I also left myself a few rough reminders for the next day so I would not have to rediscover the same context again.
